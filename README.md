...
..\src\aligned_buffer.cc(7): warning C4189: 't': local variable is initialized but not referenced
...
/opt/cmake/bin/cmake -E __run_co_compile --tidy="/usr/bin/clang-tidy-6.0;-enable-check-profile;-checks=''" --source=/tmp/workspace/llvm-demo/src/aligned_buffer.cc -- /usr/bin/c++   -I/tmp/workspace/llvm-demo/inc  -g   -O0 -Wall
-Wextra -std=gnu++11 -o CMakeFiles/llvm-demo.dir/src/aligned_buffer.cc.o -c /tmp/workspace/llvm-demo/src/aligned_buffer.cc
...
/tmp/workspace/llvm-demo/src/aligned_buffer.cc:6:14: warning: unused variable 'comp_ptr' [clang-diagnostic-unused-variable]
  const TU8* comp_ptr = static_cast<const TU8*>(buf_ptr);
             ^
/tmp/workspace/llvm-demo/src/aligned_buffer.cc:7:14: warning: unused variable 't' [clang-diagnostic-unused-variable]
  const TU8* t = NULL;
             ^
...
/tmp/workspace/llvm-demo/src/aligned_buffer.cc:6:14: warning: unused variable ‘comp_ptr’ [-Wunused-variable]
   const TU8* comp_ptr = static_cast<const TU8*>(buf_ptr);
              ^
/tmp/workspace/llvm-demo/src/aligned_buffer.cc:7:14: warning: unused variable ‘t’ [-Wunused-variable]
   const TU8* t = NULL;
              ^
